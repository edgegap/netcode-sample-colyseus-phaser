...
Click on “version”
 ...
 ![Alt text for the image](server/2.png)

Click on “create application”

![Alt text for the image](server/3.png)

Give it a name and click on “create application”

![Alt text for the image](server/4.png) 
...
![Alt text for the image](server/5.png)
...
![Alt text for the image](server/11.png) 
...
![Alt text for the image](server/12.png)
 
You will get a similar page:

 ![Alt text for the image](server/13.png)
...
From there you can go back and connect to the client port. It’ll allow you to select one of the 4 mode by clicking on them. 
 ...
 ![Alt text for the image](server/14.png)
